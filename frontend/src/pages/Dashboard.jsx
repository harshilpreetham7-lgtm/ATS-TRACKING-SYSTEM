    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="mx-auto max-w-[1440px] px-4 pb-16 pt-6 sm:px-6 lg:px-8 lg:pb-20 lg:pt-8">
        ...
        <section className="mb-12 text-center">
          <p className="inline-flex items-center gap-2 rounded-full bg-slate-900/60 px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-slate-400 ring-1 ring-slate-700/50">
            <Zap size={14} />
            Workspace
          </p>
          <p className="mx-auto mt-4 inline-flex rounded-full border border-slate-700 bg-slate-900/70 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.24em] text-slate-400">
          ...
          <p className="mt-4 text-lg leading-8 text-slate-400">
            Manage roles, candidates, and hiring workflows in one simple workspace.
          </p>
        </section>
        ...
        <div className="mb-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <div className="rounded-[1.8rem] border border-slate-800 bg-slate-900/90 p-6">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-400 font-semibold">Open roles</p>
            <p className="mt-3 text-3xl font-semibold text-white">{totalJobs}</p>
            <p className="mt-2 text-xs text-slate-500">Active positions</p>
          </div>
          <div className="rounded-[1.8rem] border border-slate-800 bg-slate-900/90 p-6">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-400 font-semibold">Applications</p>
          ...
          <div className="rounded-[1.8rem] border border-slate-800 bg-slate-900/90 p-6">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-400 font-semibold">Shortlisted</p>
            <p className="mt-3 text-3xl font-semibold text-white">{statusCount.shortlisted}</p>
            <p className="mt-2 text-xs text-slate-500">Ready to interview</p>
          </div>
          <div className="rounded-[1.8rem] border border-slate-800 bg-slate-900/90 p-6">
            <p className="text-sm uppercase tracking-[0.24em] text-slate-400 font-semibold">Conversion</p>
            <p className="mt-3 text-3xl font-semibold text-white">{conversionRate}%</p>
            <p className="mt-2 text-xs text-slate-500">Offer rate</p>
          </div>
        </div>
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <button
              ...
              className="group rounded-[2rem] border border-slate-800 bg-slate-900/80 p-6 text-left transition hover:border-slate-700 hover:bg-slate-900"
            >
              <div className="flex items-start justify-between gap-3">
                <div className="rounded-[1.2rem] bg-slate-900/80 p-4">
                  <Briefcase className="text-slate-400" size={28} />
                </div>
                <span className="text-sm font-bold text-slate-600">1</span>
              </div>
              <h3 className="mt-4 text-lg font-semibold text-white transition group-hover:text-slate-100">Browse Roles</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400 transition group-hover:text-slate-300">
                Explore open positions with role details.
              </p>
            </button>
            ...
            >
              ...
              <h3 className="mt-4 text-lg font-semibold text-white transition group-hover:text-slate-100">Pipeline Board</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400 transition group-hover:text-slate-300">
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="rounded-[1.2rem] bg-slate-900/80 p-4">
                  <Zap className="text-slate-400" size={28} />
                </div>
                <span className="inline-flex items-center rounded-full bg-slate-800 px-2 py-1 text-xs font-bold text-slate-400 ring-1 ring-slate-700">PRO</span>
              </div>
              <h3 className="mt-4 text-lg font-semibold text-white transition group-hover:text-slate-100">Workflow Forms</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400 transition group-hover:text-slate-300">
                Create structured workflows for processes
              </p>
            </button>
            ...
            >
              ...
              <h3 className="mt-4 text-lg font-semibold text-white transition group-hover:text-slate-100">Analytics</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400 transition group-hover:text-slate-300">
                Track metrics and hiring insights
              </p>
            </button>
            ...
            >
              ...
              <h3 className="mt-4 text-lg font-semibold text-white transition group-hover:text-slate-100">Activity Stream</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400 transition group-hover:text-slate-300">
                View recent pipeline changes
              </p>
            </button>
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="text-sm font-bold text-slate-600">6</span>
              </div>
              <h3 className="mt-4 text-lg font-semibold text-white transition group-hover:text-slate-100">Settings</h3>
              <p className="mt-2 text-sm leading-6 text-slate-400 transition group-hover:text-slate-300">
